...
# 행명칭(rownames)이 불필요하게 복잡해져, 행명칭을 제거하면, 자동적으로 R이 순차적으로 행명칭을 부여
rownames(r) <- NULL
rownames(french_fries) <- NULL  # french_fries에 특이하게 부여된 행번호를 무시
identical(r, french_fries)  # 동일한 객체인지 확인
```
